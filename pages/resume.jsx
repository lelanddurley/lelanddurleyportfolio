...
const resume = () => {
  const pixieStartDate = moment("2020-10-01");
  const pixieDuration = jobDuration(pixieStartDate);
  return (
    <>
      ...
      <Head>
        ...
        <meta
          name="description"
          content="I’m a Full-Stack Developer specializing in building (and designing) cutting-edge digital experiences for customers, enterprises, and friends."
        />
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="py-6">
          <p className="italic">
            ...
            <span className="px-2">|</span> 8 mo
          </p>
          <p className="py-1 italic">Developer I (2023-2023)</p>
        ...
        <div className="py-6">
          <p className="italic">
            ...
            <span className="px-2">|</span> {pixieDuration}
            {/* <span className="px-2">|</span> 2 yr 8 mo  Pixie Started: October 2020
 */}          </p>
