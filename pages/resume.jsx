  ...
  return (
    <>
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <p>
          Analytical, innovative, and coachable full-stack development
          professional with experience in customer service, team leadership, and
          business analysis. Well-versed in Client-side and Server-side
          rendering, and also passionate about building enterprises for the
          right reasons. Adept at problem-solving, developing strategies, also
          driving streamlined operations. I am experienced in multiple front-end
          and back-end languages, but I am also open to learning new ones when
          the opportunity presents itself. Empathetic professional, and
          motivated leader, with solid interpersonal abilities that empower me
          to strengthen relationships within and beyond an enterprise.
        </p>
        ...
        <div className="text-center py-4">
          ...
          <p className="py-2">
            ...
            <span className="px-2">|</span>Geo-redundant Storage
          </p>
        </div>
