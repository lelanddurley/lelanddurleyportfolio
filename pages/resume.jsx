    ...
    <>
      ...
      <div className="max-w-[940px] mx-auto p-2 pt-[120px]">
        ...
        <div className="text-center py-4">
          ...
          <p className="py-2 break-words">
            NextJS | Redis | ASP.NET | ReactJS | VueJS
          </p>
          ...
          <p className="py-2 break-words">
            Tailwind | Graphic design (PDF, SVG, Figma) | Microsoft Power BI |
            Perfomance testing
          </p>
        ...
        <div className="py-6">
          ...
          <p className="py-1 italic">Back End Developer (2023-Current)</p>
          <ul className="list-disc list-outside px-7 py-1 leading-relaxed">
            <li>
              Worked as a crucial part of the Software Configuration Management
              (SCRM) team at a healthcare company, where I applied my expertise
              as a Back-End Developer to optimize and enhance the company's
              websites and mobile applications (Android & iOS). Successfully
              utilized NodeJS and MSSQL to develop effective data interfaces,
              ensuring seamless performance across all platforms.
            </li>
            <li>
              Contribute to front-end & back-end development operations,
              implementing robust SQL queries to support API endpoints,
              conducting code reviews for efficiency, and innovatively solving
              web design issues for better usability and visual appeal.
            </li>
            <li>
              Actively participated in monitoring and maintaining API
              performance and data layers. Played a key role in integrating
              third-party APIs into our company's systems, enhancing
              functionality and streamlining operations. Further, contributed to
              the planning and execution of both internal and external web
              projects under the direct supervision of the Chief Information
              Officer.
            </li>
          </ul>
        </div>
...
const jobDuration = (startDate) => {
  ...
  startDate.add(years, "years"); // increase start date by the calculated years

  const months = currentDate.diff(startDate, "months");
  startDate.add(months, "months"); // increase start date by the calculated months
