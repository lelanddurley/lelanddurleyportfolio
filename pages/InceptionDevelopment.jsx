...
import InceptionImg from "../public/assets/projects/InceptionFertilityIMG.webp";
...
const InceptionDevelopment = () => {
  ...
  <br /><br />
  Moreover, I lead the revamp of two mobile & web applications, serving tens of thousands of patients and focusing on user accessibility and staff workflow efficiency. The cron server automation is crucial for routine tasks like data backups and report generation. My responsibilities also encompass API integration, continuous performance monitoring, and spearheading AI-driven projects for predictive analytics and administrative automation.
  <br /><br />
